          ...
          <div className="flex items-center w-full max-w-3xl p-8 mx-auto lg:px-12 lg:w-3/5">
            <div className="w-full">
              ...
              <form className="grid grid-cols-1 gap-6 mt-8 md:grid-cols-2" onSubmit={handleFormSubmit}>
                ...
                <button
                  className="flex items-center justify-between w-full px-6 py-3 text-lg lg:text-sm tracking-wide text-white capitalize transition-colors duration-300 transform bg-fernGreen rounded-lg hover:bg-coolGray focus:outline-none focus:ring focus:ring-fernGreen focus:ring-opacity-50">
                  <span>Sign Up </span>
